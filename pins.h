...
//pin constants
static const unsigned clkPin = 53; //pin for tempo LED, also used for debugging loops

static const unsigned ledMuxPins[5] = {26,27,28,29,30}; //4 pins for interfacing multiplexer + 1 signal pin
...
static const unsigned extClockTogglePin = 23; //when clock source is internal, toggle for whether clock is running or not
