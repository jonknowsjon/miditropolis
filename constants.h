...
const char MENU_TEXT[8][11] = {"KEY", "SCALE", "NOTE MODE", "CLK DIV", "ARP TYPE", "CLOCK SRC"};


int PLAY_MODES_ITEMCOUNT = 3;
enum PLAY_MODES {CHORD, SINGLE, ARP};
const char PLAY_MODES_TEXT[3][11] = {"Chord", "Note", "Arpeggio"};
...
const char ARPTYPE_TEXT[4][7] = {"UP","DOWN","UP&DOWN"};
